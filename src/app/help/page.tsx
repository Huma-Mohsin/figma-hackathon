...
const Helppage = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-10'>
        ...
        <div className="flex px-4 py-3 rounded-md w-full max-w-md lg:w-[30%] border-2 border-text-secondary-gray mt-4 justify-between">
            <input className="focus-visible:outline-none w-full lg:w-[64%]" type="text" placeholder="What can we help you with?" />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 md:px-16 pt-14 pb-10 bg-white text-gray-800 w-full">
            <div className='col-span-1 lg:col-span-9 border-none lg:border-r-[1.3px] pr-0 md:pr-4 border-text-secondary-gray'>
                ...
                <div className='flex flex-col lg:flex-row gap-4'>
                    <button type="submit" className="w-full py-3 bg-black text-white rounded hover:bg-gray-800 transition-colors">
                        Join Us
                    </button>
                    <button type="submit" className="w-full py-3 bg-black text-white rounded hover:bg-gray-800 transition-colors">
                        Shop Nike
            ...
            <div className='col-span-1 lg:col-span-3 pt-10 lg:pt-0 space-y-14 px-6 lg:px-10'>

...
import FetchData from '../components/externalapidatacode';
  ...
  return (
    <div className="grid grid-cols-12 px-4 md:px-10 py-20 relative">
      ...
      >
        ...
        <ul className="mt-4">
          <li className="leading-8"><Link href="/shoes">Shoes</Link></li>
          <li className="leading-8"><Link href="/sports">Sports Bras</Link></li>
          <li className="leading-8"><Link href="/tops">Tops & T-Shirts</Link></li>
          <li className="leading-8"><Link href="/hoodies">Hoodies & Sweatshirts</Link></li>
          <li className="leading-8"><Link href="/jackets">Jackets</Link></li>
          <li className="leading-8"><Link href="/trousers">Trousers & Tights</Link></li>
          <li className="leading-8"><Link href="/shorts">Shorts</Link></li>
          <li className="leading-8"><Link href="/tracksuit">Tracksuits</Link></li>
          <li className="leading-8"><Link href="/jumpsuit">Jumpsuits & Rompers</Link></li>
          <li className="leading-8"><Link href="/skirts">Skirts & Dresses</Link></li>
          <li className="leading-8"><Link href="/socks">Socks</Link></li>
          <li className="leading-8"><Link href="/accessories">Accessories & Equipment</Link></li>
        </ul>

        ...
        {menClothingData.map((item) => (
          ...
          >
            ...
            <div className="flex justify-center gap-4 p-4">
              ...
              <button className="bg-gradient-to-r from-red-500 to-red-700 shadow-md text-white py-2 px-3 rounded-xl hover:bg-pink-700 transition duration-200">                Add to Wishlist
              </button>
            </div>
          </div>
        ))}
